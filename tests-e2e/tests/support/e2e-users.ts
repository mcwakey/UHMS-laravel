...
const users: E2EUser[] = [
  ...
  ...optionalCredentialsFor('UHMS_PHARMACY_EMAIL', 'UHMS_PHARMACY_PASSWORD', 'Pharmacist', `${employeeIdPrefix}PHARMACY`, [
    'patients.view',
    'visits.view',
    'prescriptions.view',
  ...
  ...optionalCredentialsFor('UHMS_STORE_EMAIL', 'UHMS_STORE_PASSWORD', 'Store Keeper', `${employeeIdPrefix}STORE`, [
    'patients.view',
    'pharmacy.drugs.manage',
    'pharmacy.stock.manage',
    'product.view',
