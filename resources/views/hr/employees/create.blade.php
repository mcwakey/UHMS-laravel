...
<form method="POST" action="{{ route('admin.hr.employees.store') }}">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="basic_salary" class="form-control" step="0.01" value="{{ old('basic_salary', 0) }}" required>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="ssnit_number" class="form-control" value="{{ old('ssnit_number') }}">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <select name="tax_residency_status" class="form-select">
                                @foreach(['resident', 'non_resident', 'exempt'] as $type)<option value="{{ $type }}" @selected(old('tax_residency_status', 'resident') === $type)>{{ __('payroll.'.$type) }}</option>@endforeach
                            </select>
                        </div>
                        <div class="col-12"><label class="form-label">{{ __('payroll.tax_identification_number') }}</label><input name="tax_identification_number" class="form-control" value="{{ old('tax_identification_number') }}"></div>
                        <div class="col-6"><label class="form-label">{{ __('payroll.tax_reliefs') }}</label><input type="number" step="0.01" min="0" name="tax_relief_amount" class="form-control" value="{{ old('tax_relief_amount', 0) }}"></div>
                        <div class="col-6"><label class="form-label">SSNIT %</label><input type="number" step="0.0001" min="0" name="employee_ssnit_rate" class="form-control" value="{{ old('employee_ssnit_rate', 5.5) }}"></div>
                    </div>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-primary w-100"><i class="ti ti-device-floppy me-1"></i>Save Employee</button>
        </div>
    </div>
</form>
@endsection
