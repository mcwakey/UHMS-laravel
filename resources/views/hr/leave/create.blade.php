...
<div class="d-flex align-items-center mb-3 pb-3 border-bottom">
    <div class="flex-grow-1">
        <h4 class="fw-bold mb-0">Submit Leave Request</h4>
    </div>
    <a href="{{ route('admin.hr.leave.index') }}" class="btn btn-outline-secondary"><i class="ti ti-arrow-left me-1"></i>Back</a>
</div>
    ...
    <div class="col-lg-4">
        <div class="card border-info">
            <div class="card-header bg-info bg-opacity-10">
                <h5 class="card-title mb-0"><i class="ti ti-info-circle me-1"></i>Leave Policy</h5>
            </div>
            <div class="card-body">
                <ul class="mb-0 ps-3">
