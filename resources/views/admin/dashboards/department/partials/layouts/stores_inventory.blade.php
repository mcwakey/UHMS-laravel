{{-- Stores inventory: stock requests/issues, low-stock and movements emphasis. --}}
@include('admin.dashboards.department.partials.layouts._primary-cards')

<div class="row g-3">
    <div class="col-xl-8">
        <h6 class="fw-bold text-muted text-uppercase small mb-2"><i class="ti ti-truck-loading me-1"></i>{{ __('departments.sections.stock_movements') }}</h6>
