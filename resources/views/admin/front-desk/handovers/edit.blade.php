...
<div class="d-flex align-items-center mb-3 pb-3 border-bottom">
    ...
    <a href="{{ $workspaceRoutes->route('admin.front-desk.handovers.show', $log) }}" class="btn btn-outline-secondary"><i class="ti ti-arrow-left me-1"></i>{{ __('front_desk.actions.back') }}</a>
</div>
