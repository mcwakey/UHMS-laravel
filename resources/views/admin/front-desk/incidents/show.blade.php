...
<div class="d-flex align-items-center mb-3 pb-3 border-bottom">
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="{{ $workspaceRoutes->route('admin.front-desk.incidents.edit', $log) }}" class="btn btn-outline-secondary"><i class="ti ti-edit me-1"></i>{{ __('front_desk.actions.edit') }}</a>
        @endcan
        ...
        @endcan
        <a href="{{ $workspaceRoutes->route('admin.front-desk.incidents.index') }}" class="btn btn-outline-secondary"><i class="ti ti-arrow-left me-1"></i>{{ __('front_desk.actions.back') }}</a>
    </div>
</div>
...
<div class="modal fade" id="assignModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST" action="{{ $workspaceRoutes->route('admin.front-desk.incidents.assign', $log) }}">@csrf
...
@can('front_desk.incidents.escalate')
@if($log->isOpen())
<div class="modal fade" id="escalateModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST" action="{{ $workspaceRoutes->route('admin.front-desk.incidents.escalate', $log) }}">@csrf
...
@can('front_desk.incidents.resolve')
@if($log->isOpen())
<div class="modal fade" id="resolveModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST" action="{{ $workspaceRoutes->route('admin.front-desk.incidents.resolve', $log) }}">@csrf
...
@can('front_desk.incidents.cancel')
@if($log->isOpen())
<div class="modal fade" id="cancelModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST" action="{{ $workspaceRoutes->route('admin.front-desk.incidents.cancel', $log) }}">@csrf
