...
<div class="page-wrapper">
    <div class="content">
        ...
        <x-page-header :title="$provider->name" :description="__('payments.gateway.payment_provider')" icon="ti-credit-card"
            :breadcrumbs="[
        ...
        <div class="row g-3">
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.integrations.payments.providers.update', $provider) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-6">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        @can('integrations.payments.credentials.manage')
                            <p class="text-muted small">{{ __('integrations.leave_blank_keep') }} {{ __('integrations.credentials_never_shown') }}</p>
                            <form method="POST" action="{{ route('admin.integrations.payments.providers.credentials.update', $provider) }}">
                                @csrf
                                @method('PUT')
