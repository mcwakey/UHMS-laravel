<div class="row g-2 mb-2 align-items-end">
        ...
        @switch($c->input_type)
            ...
            @case('boolean')
                <select name="values[{{ $c->id }}][value]" class="form-select form-select-sm">
                    <option value="">— —</option>
                    <option value="yes" @selected($c->default_value === 'yes')>Yes</option>
                    <option value="no"  @selected($c->default_value === 'no')>No</option>
                </select>
                @break
            @default
    ...
    <div class="col-md-2">
        <label class="form-label small mb-1">Flag</label>
