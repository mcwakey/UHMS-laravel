...
<div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-bottom">
    <div class="flex-grow-1">
        ...
        <small class="text-muted">One row per return batch (managed location → Main Store). Click a row to reveal its line items.</small>
    </div>
    <div>
...
<div class="card">
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            @empty
                <tr><td colspan="7"><x-empty-state icon="ti-arrow-back-up" title="No returns" message="No stock return batches match your filters." /></td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
