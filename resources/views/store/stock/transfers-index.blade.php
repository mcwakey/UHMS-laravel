...
<div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-bottom">
    <div class="flex-grow-1">
        ...
        <small class="text-muted">Stock moved from the Main Store to managed locations. Click a line to see its full detail.</small>
    </div>
    <div>
...
<div class="card">
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            @empty
                <tr><td colspan="7"><x-empty-state icon="ti-transfer" title="No transfers" message="No stock transfers match your filters." /></td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
