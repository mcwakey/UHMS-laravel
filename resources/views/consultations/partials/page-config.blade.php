...
@php
    $consultationPageConfig = [
        ...
        'routes' => [
            'summaryFragment' => $workspaceRoutes->route('admin.consultations.summary-fragment', $visit),
            'readinessFragment' => $workspaceRoutes->route('admin.consultations.readiness-fragment', $visit),
            'deptServicesBase' => url('admin/departments'),
            'procedureDeptServicesBase' => url('admin/theatre/departments'),
            'departmentVisitOptions' => $workspaceRoutes->route('admin.departments.visit-options', ['department' => '__ID__']),
            'patternsBase' => url('admin/patterns'),
            'patternSuggest' => $workspaceRoutes->route('admin.patterns.suggest'),
            'icdSearch' => $workspaceRoutes->route('admin.icd-search'),
            'suggest' => [
                'complaint' => $workspaceRoutes->route('admin.consultations.suggest.complaints'),
                'diagnosis' => $workspaceRoutes->route('admin.consultations.suggest.diagnoses'),
            ],
        ],
        'translations' => [
