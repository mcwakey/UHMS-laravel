                ...
                <form method="POST" action="{{ $summaryRoute }}">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            <input name="primary_diagnosis" class="form-control form-control-sm" value="{{ old('primary_diagnosis', $summary?->primary_diagnosis ?? $admission->admitting_diagnosis) }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small">{{ __('admissions.discharge_condition') }}</label>
                            <input name="discharge_condition" class="form-control form-control-sm" value="{{ old('discharge_condition', $summary?->discharge_condition) }}">
                        </div>
                        <div class="col-12">
                            <label class="form-label small">{{ __('admissions.secondary_diagnoses') }}</label>
                            <textarea name="secondary_diagnoses" rows="2" class="form-control form-control-sm">{{ old('secondary_diagnoses', collect($summary?->secondary_diagnoses ?? [])->implode("\n")) }}</textarea>
                        </div>
                        @foreach([
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="{{ $field }}" rows="2" class="form-control form-control-sm">{{ old($field, $summary?->{$field}) }}</textarea>
                            </div>
                        @endforeach
                        <div class="col-md-6">
                            <label class="form-label small">{{ __('admissions.follow_up_date') }}</label>
                            <input type="date" name="follow_up_date" class="form-control form-control-sm" value="{{ old('follow_up_date', $summary?->follow_up_date?->format('Y-m-d')) }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small">{{ __('admissions.final_outcome') }}</label>
                            <input name="final_outcome" class="form-control form-control-sm" value="{{ old('final_outcome', $summary?->final_outcome) }}">
                        </div>
                    </div>
