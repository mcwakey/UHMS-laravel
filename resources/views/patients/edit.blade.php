        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="nhis_number" class="form-control @error('nhis_number') is-invalid @enderror" value="{{ old('nhis_number', $patient->nhis_number) }}">
                    @error('nhis_number')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-4 mb-3">
                    <label class="form-label">NHIS Expiry Date</label>
                    <input type="date" name="nhis_expiry_date" class="form-control @error('nhis_expiry_date') is-invalid @enderror" value="{{ old('nhis_expiry_date', $patient->nhis_expiry_date?->format('Y-m-d')) }}">
