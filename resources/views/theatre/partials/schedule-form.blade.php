@php
    ...
    $title = $isReschedule ? __('theatre.reschedule_procedure') : __('theatre.schedule_procedure');
...
<div class="card shadow-sm mb-3">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route($route, $procedure) }}">
            ...
            <div class="row g-2">
                <div class="col-md-6">
                    <label class="form-label small">{{ __('theatre.theatre_room') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    <label class="form-label small">{{ __('theatre.start') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    <label class="form-label small">{{ __('theatre.anaesthetist') }}</label>
                ...
                <div class="col-md-3">
                    <label class="form-label small">{{ __('theatre.assistant_surgeon') }}</label>
                ...
                <div class="col-md-12">
                    <label class="form-label small">{{ __('theatre.required_equipment') }}</label>
                ...
                @if ($isReschedule)
                    <div class="col-md-12">
                        <label class="form-label small">{{ __('theatre.reschedule_reason') }} <span class="text-danger">*</span></label>
                ...
                @can('theatre.schedule.override')
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="override_room_conflict_{{ $mode }}">{{ __('theatre.override_room_conflict') }}</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label small">{{ __('theatre.override_reason') }}</label>
                        <textarea name="override_reason" class="form-control form-control-sm" rows="2">{{ old('override_reason') }}</textarea>
                    </div>
                @endcan
            </div>
            <button class="btn btn-primary mt-3">{{ $isReschedule ? __('theatre.reschedule') : __('theatre.schedule') }}</button>
        </form>
    </div>
</div>
