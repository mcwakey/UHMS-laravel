...
@section('content')
<x-page-header :title="$title" icon="ti-building-bank" description="From posted journal entries, grouped by department." />
...
<div class="card mb-3"><div class="card-body py-2 d-flex justify-content-between"><span class="fw-semibold">Grand Total</span><span class="fw-bold fs-5">{{ $money($report['grand_total']) }}</span></div></div>
...
@empty
    <x-empty-state icon="ti-building-bank" title="No data" message="No posted entries for this period." />
@endforelse
@endsection
