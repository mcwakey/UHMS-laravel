    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Payment Methods Configuration</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                <form method="POST" action="{{ route('admin.settings.payment-methods.update') }}">
                    ...
                    <h6 class="fw-bold mb-3">Enabled Payment Methods</h6>
                    <div class="row mb-4">
                        <div class="col-md-4 mb-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="cashEnabled"><i class="ti ti-cash me-1"></i>Cash</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="momoEnabled"><i class="ti ti-device-mobile me-1"></i>Mobile Money</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="cardEnabled"><i class="ti ti-credit-card me-1"></i>Card Payment</label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-2">
                            <div class="form-check form-switch">
                        ...
                        <div class="col-md-4 mb-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="bankEnabled"><i class="ti ti-building-bank me-1"></i>Bank Transfer</label>
                            </div>
                        </div>
                    </div>

                    <hr class="my-3">
                    <h6 class="fw-bold mb-3">Mobile Money Settings</h6>
                    <div class="row mb-4">
