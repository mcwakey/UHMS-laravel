...
<div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
    <div>
        <h4 class="fw-bold mb-0">Activity & Audit Logs</h4>
...
<div class="card mb-3">
    <div class="card-body">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-1">
                <label class="form-label mb-1">Visit</label>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <span class="badge bg-secondary">{{ $totalCount }} entries</span>
    </div>
                ...
                <tbody>
                    @forelse($activities as $activity)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.logs.show', $activity->id) }}" class="btn btn-sm btn-outline-secondary" title="View details">
                                    <i class="ti ti-eye"></i>
                                </a>
                            </td>
                        </tr>
