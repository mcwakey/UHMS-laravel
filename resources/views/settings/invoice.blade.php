    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Invoice Configuration</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                ...
                <form method="POST" action="{{ route('admin.settings.invoice.update') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">e.g. INV-, UHMS-</small>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Number of days before invoice is due</small>
                        </div>
                    </div>

                    <hr class="my-3">
                    <h6 class="fw-bold mb-3">Tax Configuration</h6>
