...
return [
    ...
    */
    'status' => [
        ...
        // ── Billing payment policy (context-aware payment gate) ──
        'settlement' => [
            'UNBILLED' => 'secondary',
            'BILLED_UNPAID' => 'danger',
            'PARTIALLY_PAID' => 'warning',
            'PAID' => 'success',
            'COVERED_BY_INSURANCE' => 'info',
            'WAIVED' => 'info',
            'CREDIT_APPROVED' => 'info',
            'DEFERRED_APPROVED' => 'primary',
            'CANCELLED' => 'secondary',
        ],
        'service_readiness' => [
            'READY_TO_RENDER' => 'success',
        ...
        'billing_policy' => [
            'STRICT_PAY_BEFORE_SERVICE' => 'warning',
            'DEFERRED_VISIT_SETTLEMENT' => 'primary',
            'RUNNING_BILL' => 'info',
            'INSURANCE_COVERED' => 'info',
            'CREDIT_APPROVED' => 'info',
            'WAIVED' => 'info',
            'PAYMENT_GATE_BYPASS' => 'dark',
            'ADVISORY' => 'secondary',
        ],
        'billing_override' => [
            'ACTIVE' => 'success',
            ...
            'EXPIRED' => 'secondary',
            'COMPLETED' => 'info',
            'DEFERRED_OPD_SETTLEMENT' => 'primary',
            'PAYMENT_GATE_BYPASS' => 'dark',
            'CREDIT_APPROVAL' => 'info',
            'MANAGEMENT_APPROVAL' => 'info',
            'INSURANCE_AUTHORIZATION_PENDING' => 'warning',
        ],
        'discharge_clearance' => [
            'CLEARED' => 'success',
        ...
        // ── External Integrations (SMS & Payment gateways) ──────────────
        ...
        'payment_transaction' => [
            ...
            'INITIATED' => 'info',
            'PENDING' => 'warning',
            'REQUIRES_CUSTOMER_ACTION' => 'warning',
            'AUTHORIZED' => 'info',
            'PAID' => 'success',
            'VERIFIED' => 'success',
            'RECONCILED' => 'success',
