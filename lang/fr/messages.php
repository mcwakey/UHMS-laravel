...
return [
    ...
    'accounting' => [
        ...
        'fiscal_year_reopened'     => 'Exercice fiscal rouvert.',
        'year_end_closed'          => 'Écriture de clôture annuelle créée.',
        'period_created'           => 'Période comptable créée.',
        'period_closed'            => 'Période comptable clôturée.',
        'period_reopened'          => 'Période comptable rouverte.',
        ...
        'bank_account_disabled'    => 'Compte bancaire désactivé.',
        'statement_imported'       => 'Relevé bancaire importé (:count lignes).',
        'statement_rejected'       => 'Import de relevé bancaire rejeté.',
        'reconciliation_prepared'  => 'Rapprochement bancaire préparé.',
        'reconciliation_approved'  => 'Rapprochement bancaire approuvé et verrouillé.',
        'reconciliation_reopened'  => 'Rapprochement bancaire rouvert.',
        'reconciliation_reversed'  => 'Rapprochement bancaire contrepassé.',
        'line_matched'             => 'Ligne de relevé rapprochée.',
        'line_unmatched'           => 'Ligne de relevé non rapprochée.',
        'adjustment_proposed'      => 'Ajustement proposé.',
    ...
    'consultations' => [
        ...
        'prescription_department_handoff_sent' => 'Patient envoyé à :department. La session de consultation a été mise en pause.',
        'prescription_handoff_notes' => 'Ordonnance :number envoyée à :department.',
        'prescription_department_no_open_request' => 'Aucune ordonnance ouverte pour ce département dans cette session.',
        'pharmacy_department_missing' => 'Aucun département de pharmacie actif n\'est configuré.',
        ...
        'investigation_handoff_sent' => 'Patient envoyé à :department pour la demande :number. La session de consultation a été mise en pause.',
        'investigation_department_handoff_sent' => 'Patient envoyé à :department. La session de consultation a été mise en pause.',
        'investigation_handoff_notes' => 'Demande d\'investigation :number envoyée à :department.',
        'investigation_handoff_button' => 'Envoyer le patient',
        'investigation_handoff_confirm' => 'Envoyer ce patient à :department et mettre cette session de consultation en pause ?',
        'investigation_handoff_queueing' => 'Mise en file...',
        'investigation_handoff_queued' => 'En file',
        'investigation_handoff_queued_title' => 'Le patient est déjà en file à :department.',
        'investigation_department_no_open_request' => 'Aucune demande d\'investigation ouverte pour ce département dans cette session.',
        'invalid_investigation_request' => 'La demande d\'investigation sélectionnée n\'appartient pas à cette visite.',
        'investigation_request_wrong_session' => 'Cette demande d\'investigation appartient à une autre session de consultation.',
        'investigation_request_not_sendable' => 'Cette demande d\'investigation ne peut plus être envoyée à un département.',
        'investigation_request_department_missing' => 'Cette demande d\'investigation n\'a pas de département cible.',
        'procedure_submitted'       => 'Demande de procédure soumise (:number).',
        'procedure_updated'         => 'Demande de procédure mise à jour.',
        'procedure_department_handoff_sent' => 'Patient envoyé à :department. La session de consultation a été mise en pause.',
        'procedure_handoff_notes' => 'Demande de procédure :number envoyée à :department.',
        'procedure_department_no_open_request' => 'Aucune demande de procédure ouverte pour ce département dans cette session.',
