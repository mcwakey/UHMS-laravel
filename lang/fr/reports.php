...
return [
    ...
    'consultation_specialties' => [
        'title' => 'Spécialités de consultation',
        'description' => 'Analyses des espaces spécialistes: volume, préparation, jeux d’ordres, facturation et revenus.',
        'widget_title' => 'Consultations spécialistes',
        'specialty' => 'Spécialité',
        'all_specialties' => 'Toutes les spécialités',
        'total_specialist_consultations' => 'Consultations spécialistes',
        'specialties_used' => 'Spécialités utilisées',
        'structured_entries' => 'Saisies structurées',
        'specialty_revenue' => 'Revenu spécialiste',
        'order_sets_applied' => 'Jeux d’ordres appliqués',
        'top_specialties' => 'Principales spécialités',
        'volume_by_specialty' => 'Volume par spécialité',
        'doctor_workload' => 'Charge des médecins',
        'section_completion' => 'Complétion des sections',
        'readiness_breakdown' => 'Préparation à la clôture',
        'order_set_usage' => 'Utilisation des jeux d’ordres',
        'billing_health' => 'État des correspondances de facturation',
        ...
        'order_set' => 'Jeu d’ordres',
        'applications' => 'Applications',
        'billing_mappings' => 'Correspondances de facturation',
        'auto_bill_mappings' => 'Correspondances auto-facturées',
        'billing_applications' => 'Applications de facturation',
        'unassigned_doctor' => 'Médecin non assigné',
        'summary_builder_note' => 'Le générateur de résumé est disponible dans l’espace de consultation, mais les événements de génération ne sont pas encore persistés.',
        'readiness_sample_note' => 'La préparation est évaluée sur les :count dernières consultations spécialistes de la période sélectionnée.',
        'billing_statuses' => [
