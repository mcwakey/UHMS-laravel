...
return [
    ...
    'ribbon' => [
        ...
        'pilot_hint' => 'Le profil de grossesse lié est visible ; les antécédents obstétricaux gynécologiques hérités restent modifiables.',
        'source_of_truth_hint' => 'Le profil de grossesse fait foi pour les champs d\'antécédents obstétricaux liés.',
    ...
    'messages' => [
        ...
        'legacy_patch_hint' => 'Enregistré par une application d\'ensemble d\'ordres antérieure ; conservé pour audit.',
        'unsupported_action' => 'Action maternité non prise en charge',
        'unsupported_action_hint' => 'Cette action d\'ensemble d\'ordres n\'est pas reconnue et ne sera pas exécutée.',
        'integration_disabled' => 'L\'intégration du parcours maternité n\'est pas activée',
        'use_maternity_workspace' => 'Utilisez directement le module Maternité.',
        'use_obstetrics_workflow' => 'Utilisez le parcours Obstétrique ou Maternité.',
        'not_available_in_gynaecology' => 'Non disponible en gynécologie',
        'confirm_profile_first' => 'Confirmez ou liez d\'abord un profil de grossesse.',
        'action_unavailable' => 'Action indisponible',
        'start_new_active_consultation' => 'Démarrez une nouvelle consultation active ou utilisez l\'espace Maternité.',
        'maternity_workflow_action' => 'Action de parcours maternité',
