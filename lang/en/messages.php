...
return [
    ...
    'accounting' => [
        ...
        'fiscal_year_reopened'     => 'Fiscal year reopened.',
        'year_end_closed'          => 'Year-end closing entry created.',
        ...
        'bank_account_disabled'    => 'Bank account disabled.',
        'statement_imported'       => 'Bank statement imported (:count lines).',
        'statement_rejected'       => 'Bank statement import rejected.',
        'reconciliation_prepared'  => 'Bank reconciliation prepared.',
        'reconciliation_approved'  => 'Bank reconciliation approved and locked.',
        'reconciliation_reopened'  => 'Bank reconciliation reopened.',
        'reconciliation_reversed'  => 'Bank reconciliation reversed.',
        'line_matched'             => 'Statement line matched.',
        'line_unmatched'           => 'Statement line unmatched.',
    ...
    'consultations' => [
        ...
        'prescription_department_handoff_sent' => 'Patient sent to :department. The consultation session was paused.',
        'prescription_handoff_notes' => 'Prescription :number sent to :department.',
        'prescription_department_no_open_request' => 'There is no open prescription for that department in this session.',
        'pharmacy_department_missing' => 'No active pharmacy department is configured.',
        ...
        'investigation_handoff_sent' => 'Patient sent to :department for request :number. The consultation session was paused.',
        'investigation_department_handoff_sent' => 'Patient sent to :department. The consultation session was paused.',
        'investigation_handoff_notes' => 'Investigation request :number sent to :department.',
        'investigation_handoff_button' => 'Send patient',
        'investigation_handoff_confirm' => 'Send this patient to :department and pause this consultation session?',
        'investigation_handoff_queueing' => 'Queueing...',
        'investigation_handoff_queued' => 'Queued',
        'investigation_handoff_queued_title' => 'Patient is already queued at :department.',
        'investigation_department_no_open_request' => 'There is no open investigation request for that department in this session.',
        'invalid_investigation_request' => 'The selected investigation request does not belong to this visit.',
        'investigation_request_wrong_session' => 'This investigation request belongs to another consultation session.',
        'investigation_request_not_sendable' => 'This investigation request can no longer be sent to a department.',
        'investigation_request_department_missing' => 'This investigation request does not have a target department.',
        'procedure_submitted'       => 'Procedure request submitted (:number).',
        'procedure_updated'         => 'Procedure request updated.',
        'procedure_department_handoff_sent' => 'Patient sent to :department. The consultation session was paused.',
        'procedure_handoff_notes' => 'Procedure request :number sent to :department.',
        'procedure_department_no_open_request' => 'There is no open procedure request for that department in this session.',
