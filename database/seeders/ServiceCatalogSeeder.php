...
class ServiceCatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $departmentServices = [
            ...
            'Laboratory' => [
                ['name' => 'Full Blood Count (FBC)', 'code' => 'LAB-FBC', 'category' => 'lab', 'price' => 80.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Malaria RDT', 'code' => 'LAB-MAL', 'category' => 'lab', 'price' => 40.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_POSITIVE_NEGATIVE, 'overall_result_positive_label' => 'Positive', 'overall_result_negative_label' => 'Negative'],
                ['name' => 'Urinalysis', 'code' => 'LAB-URI', 'category' => 'lab', 'price' => 50.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Liver Function Test', 'code' => 'LAB-LFT', 'category' => 'lab', 'price' => 120.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Renal Function Test', 'code' => 'LAB-RFT', 'category' => 'lab', 'price' => 120.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Blood Group & Cross Match', 'code' => 'LAB-BGX', 'category' => 'lab', 'price' => 80.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Widal Test', 'code' => 'LAB-WID', 'category' => 'lab', 'price' => 60.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'HIV Screening', 'code' => 'LAB-HIV', 'category' => 'lab', 'price' => 50.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_POSITIVE_NEGATIVE, 'overall_result_positive_label' => 'Reactive', 'overall_result_negative_label' => 'Non-reactive'],
                ['name' => 'Hepatitis B Test', 'code' => 'LAB-HBV', 'category' => 'lab', 'price' => 60.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_POSITIVE_NEGATIVE, 'overall_result_positive_label' => 'Reactive', 'overall_result_negative_label' => 'Non-reactive'],
                ['name' => 'Pregnancy Test (HCG)', 'code' => 'LAB-HCG', 'category' => 'lab', 'price' => 40.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_POSITIVE_NEGATIVE, 'overall_result_positive_label' => 'Positive', 'overall_result_negative_label' => 'Negative'],
            ],
            'Pharmacy' => [
                ['name' => 'Dispensing Fee', 'code' => 'PHM-DSP', 'category' => 'pharmacy', 'price' => 10.00],
            ],
            'Radiology / X-Ray' => [
                ['name' => 'Chest X-Ray', 'code' => 'RAD-CXR', 'category' => 'imaging', 'price' => 150.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Abdominal X-Ray', 'code' => 'RAD-ABX', 'category' => 'imaging', 'price' => 150.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Abdominal Ultrasound', 'code' => 'RAD-AUS', 'category' => 'imaging', 'price' => 200.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
                ['name' => 'Pelvic Ultrasound', 'code' => 'RAD-PUS', 'category' => 'imaging', 'price' => 200.00, 'overall_result_type' => ServiceCatalog::OVERALL_RESULT_FREE_TEXT],
            ],
            'Physiotherapy' => [
            ...
            foreach ($services as $svc) {
                ServiceCatalog::updateOrCreate(
                    ...
                    [
                        ...
                        'is_active' => true,
                        'overall_result_type' => $svc['overall_result_type'] ?? ServiceCatalog::OVERALL_RESULT_FREE_TEXT,
                        'overall_result_unit' => $svc['overall_result_unit'] ?? null,
                        'overall_result_min_value' => $svc['overall_result_min_value'] ?? null,
                        'overall_result_max_value' => $svc['overall_result_max_value'] ?? null,
                        'overall_result_positive_label' => $svc['overall_result_positive_label'] ?? null,
                        'overall_result_negative_label' => $svc['overall_result_negative_label'] ?? null,
                        'overall_result_true_label' => $svc['overall_result_true_label'] ?? null,
                        'overall_result_false_label' => $svc['overall_result_false_label'] ?? null,
                    ]
                );
            }
        }
