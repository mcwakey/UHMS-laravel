...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $doctorPerms = [
            ...
            'consultation.preview',
            'consultations.reopen', 'consultations.reopen_completed',
            ...
            'appointments.view', 'appointments.create', 'appointments.checkin', 'appointments.edit', 'appointments.update', 'appointments.cancel',
            'notifications.view',
        ...
        $physicianAssistant->syncPermissions(array_values(array_unique(array_merge([
            ...
            'admission.discharge.summary.view', 'admission.discharge.summary.create',
            'admission.discharge.summary.update',
            'appointments.view', 'appointments.create', 'appointments.checkin',
            'notifications.view',
        ...
        $accountant->syncPermissions([
            ...
            'billing.payment_timing.cutover.view',
            'visits.financial_clearance.view', 'visits.financial_clearance.assess',
            'visits.financial_clearance.history', 'visits.financial_clearance.report',
            'visits.financial_clearance_exception.request', 'visits.financial_clearance_exception.withdraw',
            'visits.financial_clearance_exception.history',
            'billing.payment.allocate_cross_visit', 'billing.payment.allocate_manual',
        ...
        $financeManager->syncPermissions(
            $accountant->permissions->pluck('name')->merge([
                ...
                'visits.financial_clearance.close',
                'visits.financial_clearance_exception.approve', 'visits.financial_clearance_exception.reject',
                'visits.financial_clearance_exception.revoke',
