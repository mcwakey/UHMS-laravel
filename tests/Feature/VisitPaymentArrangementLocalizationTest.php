...
class VisitPaymentArrangementLocalizationTest extends TestCase
{
    public function test_english_and_french_keys_match_recursively(): void
    {
        $en = require lang_path('en/visit_payment_arrangement.php');
        $fr = require lang_path('fr/visit_payment_arrangement.php');
