            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'Stock On Hand',
                        'icon' => 'ti ti-list-numbers',
                        'route' => 'admin.store.stock.balances',
                        'active_patterns' => ['admin.store.stock.balances'],
                        'permission' => 'store.purchase.view',
                        'module' => 'inventory',
                    ],
                    [
                        'label' => 'Stock Ledger',
                        'icon' => 'ti ti-history',
                        'route' => 'admin.store.stock.ledger',
                        'active_patterns' => ['admin.store.stock.ledger'],
                        'permission' => 'store.purchase.view',
                        'module' => 'inventory',
                    ],
                    [
                        ...
                        'route' => 'admin.store.stock.adjustments.create',
                        'active_patterns' => ['admin.store.stock.adjustments.*'],
                        'permission' => 'store.purchase.create',
                        'module' => 'inventory',
                    ],
                    [
                        'label' => 'Stock Returns',
                        'icon' => 'ti ti-rotate',
                        'route' => 'admin.store.stock.returns.create',
                    ...
                    [
                        ...
                        'route' => 'admin.store.stock.locations.index',
                        'active_patterns' => ['admin.store.stock.locations.*'],
                        'permission' => 'store.purchase.view',
                        'module' => 'inventory',
                    ],
                ],
