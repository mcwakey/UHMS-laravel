                ...
                'items' => [
                    ...
                    [
                        ...
                        'active_patterns' => [
                            ...
                            'admin.reports.consultation-specialties.*',
                        ...
                        'children' => [
                            ...
                            ['label' => 'Consultation Specialties', 'route' => 'admin.reports.consultation-specialties.index', 'active_patterns' => ['admin.reports.consultation-specialties.*'], 'permission' => 'reports.view', 'module' => 'reports'],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'active_patterns' => ['admin.integrations.payments.providers.*', 'admin.integrations.payments.callbacks.*'],
                    ...
                    [
                        ...
                        'icon' => 'ti ti-arrows-diff',
                        'route' => 'admin.integrations.payments.reconciliation.index',
                        'active_patterns' => ['admin.integrations.payments.reconciliation.*'],
                    ...
                    [
                        ...
                        'route' => 'admin.integrations.sms.queue.index',
                        'active_patterns' => ['admin.integrations.sms.queue.*'],
                        'permission' => 'integrations.sms.queue.view',
                        'module' => 'sms_gateway',
                    ],
                    [
                        'label' => 'SMS Events',
                        'icon' => 'ti ti-bell-cog',
                        'route' => 'admin.integrations.sms.events.index',
                        'active_patterns' => ['admin.integrations.sms.events.*'],
                        'permission' => 'integrations.sms.events.manage',
                        'module' => 'sms_gateway',
                    ],
                    [
                        'label' => 'Provider Health',
                        'icon' => 'ti ti-heartbeat',
                        'route' => 'admin.integrations.health.index',
            ...
            $result[] = [
                ...
                'items' => array_merge($pick([
                    ...
                    [
                        ...
                        'icon' => 'ti ti-link',
                        'route' => 'admin.integrations.payments.request-links.index',
                        'active_patterns' => ['admin.integrations.payments.request-links.*'],
                        'permission' => 'integrations.payments.request_links.manage',
                        'module' => 'payment_gateway',
                    ],
                ]),
            ];
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'active_patterns' => ['doctor.dashboard', 'doctor.dashboard.redirect', 'admin.dashboards.doctor'],
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    [
                        ...
                        'active_patterns' => ['doctor.patients.*', 'admin.patients.*'],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'active_patterns' => ['doctor.appointments.*', 'admin.appointments.*'],
                        'permission' => 'appointments.view',
                    ],
                    [
                        'label' => 'Visits / OPD',
                        'icon' => 'ti ti-calendar-check',
                        'route' => 'doctor.visits.index',
                        'active_patterns' => ['doctor.visits.*', 'admin.visits.*'],
                        'permission' => 'visits.view',
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    [
                        ...
                        'active_patterns' => ['doctor.consultations.*', 'admin.consultations.*'],
                    ...
                    [
                        ...
                        'active_patterns' => ['doctor.admissions.*', 'admin.admissions.*'],
                        'permission' => 'ward.view',
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    [
                        ...
                        'active_patterns' => ['doctor.prescriptions.*', 'admin.prescriptions.*'],
                        'permission' => 'consultation.prescribe',
                    ],
                    [
                        'label' => 'investigation Requests',
                        'icon' => 'ti ti-test-pipe',
                        'route' => 'doctor.lab.requests.index',
                        'active_patterns' => ['doctor.lab.requests.*', 'admin.lab.requests.*'],
            ...
            [
                ...
                'items' => [
                    [
                        'label' => 'Handoffs',
                        'icon' => 'ti ti-list-check',
                        'route' => 'doctor.journey.worklist',
                        'active_patterns' => ['doctor.journey.worklist', 'admin.journey.worklist'],
                        'visible' => fn (User $user) => app(DepartmentDashboardCapabilityService::class)->capabilitiesFor($user) !== [],
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => 'Medical Patterns',
                        'icon' => 'ti ti-template',
                        'route' => 'doctor.patterns.index',
                        'active_patterns' => ['doctor.patterns.*', 'admin.patterns.*'],
                        'permission' => 'consultations.view',
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    [
                        'label' => 'Clinical Reports',
                        'icon' => 'ti ti-report',
                        'route' => 'doctor.reports.visits',
                        'active_patterns' => ['doctor.reports.*', 'admin.reports.*'],
                        'permission' => 'reports.view',
                    ],
                ],
            ],
