...
{
    public const SCANNER_VERSION = 'P3-PRIVACY-SCANNER-1';
    ...
    public function __construct(?array $detectors = null)
    {
        $this->detectors = $detectors ?? [
            ...
            new RegexDetector('credential_token', '/\b(?:AKIA[0-9A-Z]{16}|gh[pousr]_[A-Za-z0-9]{20,}|Bearer\s+[A-Za-z0-9._~+\/-]{20,})\b/'),
