...
class ClinicalFrequencyOptionService
{
    ...
    public function options(): array
    {
        return [
            ...
            ['value' => 'QHS', 'label' => 'At bedtime', 'doses_per_day' => 1, 'task_instances' => 1, 'is_prn' => false],
            ...
            ['value' => 'WEEKLY', 'label' => 'Weekly', 'doses_per_day' => 1, 'task_instances' => 1, 'is_prn' => false],
            ['value' => 'MONTHLY', 'label' => 'Monthly', 'doses_per_day' => 1, 'task_instances' => 1, 'is_prn' => false],
            ['value' => 'PRN', 'label' => 'PRN - when required', 'doses_per_day' => 1, 'task_instances' => 1, 'is_prn' => true],
